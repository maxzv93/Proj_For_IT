 ...
 */
final class Version20190807151347 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment_message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, item_id_id INTEGER NOT NULL, message CLOB NOT NULL, created_at DATETIME NOT NULL, author VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE INDEX IDX_45CE526F55E38587 ON comment_message (item_id_id)');
